const byresult = require('express').Router();
var elasticsearch = require("elasticsearch");
var bodyParser = require("body-parser");
var urlencodedParser = bodyParser.urlencoded({ extended: false });
var Promise = require("bluebird");

byresult.get("/back", function (req, res, next) {
...
byresult.get("/:id", function (req, res, next) {
    var old_main_keyword = req.cookies["main_keyword"];
    var old_exclude_keyword = req.cookies["exclude_keyword"];
    let include = [];
    let exclude = [];
...
byresult.post("/", async function (req, res, next) {
    var old_main_keyword = req.cookies["main_keyword"];
    var old_exclude_keyword = req.cookies["exclude_keyword"];
